...
public class DeviceInfo {
    ...
    public static void parse(HashMap<String, Device> ipAndDeviceHashMap) {
        ...
        if (NetworkScanner.isShowVendorInfo()) {
            ...
            for (String key : ipAndDeviceHashMap.keySet()) {
                ...
                if (device != null) {
                    vendorName = getVendorName(device.getMacAddress());
        ...
        if (currentDevice != null) {
            currentDevice.setHostname(Build.MODEL);
            currentDevice.setVendorName(Build.MANUFACTURER);
        }
    }
    ...
    public static void setMacAddress(HashMap<String, Device> ipAndDeviceHashMap) {
        ...
        try {
            ...
            if (device != null) {
                device.setMacAddress(getCurrentDeviceMacAddress(currentIPAddress));
            }
